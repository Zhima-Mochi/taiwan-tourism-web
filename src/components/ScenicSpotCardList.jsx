        ...
        <div className="hidden sm:block">
            <div className="flex items-center">
                <div className="w-4 h-20">
                    {focusIdx !== 0 && <div className="btn w-4 h-20 flex items-center" onClick={() => setFocusIdx(focusIdx - jump)}>
                ...
                <div className="w-4 h-20">
                    {focusIdx + 3 < scenicspot_data.length && <div className="btn w-4 h-20 flex items-center" onClick={() => setFocusIdx(focusIdx + jump)}>
                        <div className="text-center text-xl font-bold text-gray-500">〉</div>
                    </div>}
                </div>
            </div>
